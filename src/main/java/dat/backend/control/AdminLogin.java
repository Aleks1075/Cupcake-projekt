...
public class AdminLogin extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        try
        {
            Admin admin = UserFacade.adminLogin(username, password, connectionPool);
            ...
            List<OrderLines> orderList = OrderFacade.getAllOrders(connectionPool);
            session.setAttribute("orderList", orderList);
            List<OrderLines> userAndOrderList = OrderFacade.getAllUsersAndOrders(connectionPool);
            session.setAttribute("userAndOrderList", userAndOrderList);
