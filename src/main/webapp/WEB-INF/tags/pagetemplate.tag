        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link" href="${pageContext.request.contextPath}/about.jsp">Om os</a>
                    <a class="nav-item nav-link" href="${pageContext.request.contextPath}/itemlist">Cupcakes</a>
                    <a class="nav-item nav-link" href="${pageContext.request.contextPath}/createuser.jsp">Ny Bruger</a>
